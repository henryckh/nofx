...
export default function HeaderBar({ isLoggedIn = false, isHomePage = false, currentPage, language = 'zh' as Language, user, onLogout, isAdminMode = false, onPageChange }: HeaderBarProps) {
  ...
  return (
    <nav
      ...
      style={{
        ...
        borderBottom: (isScrolled || mobileMenuOpen) ? '1px solid rgba(231, 129, 253, 0.08)' : 'transparent',
    ...
    >
                  ...
                  <div className='absolute right-0 top-full mt-2 w-32 rounded-lg shadow-lg overflow-hidden z-50' style={{ background: 'var(--brand-dark-gray)', border: '1px solid var(--panel-border)' }}>
                    <button
                      ...
                      style={{ 
                        ...
                        background: language === 'zh' ? 'rgba(231, 129, 253, 0.1)' : 'transparent'
                      }}
                    >
                    ...
                    <button
                      ...
                      style={{ 
                        color: 'var(--brand-light-gray)',
                        background: language === 'en' ? 'rgba(231, 129, 253, 0.1)' : 'transparent'
                      }}
                    >
                      <span className='text-base'>🇺🇸</span>
      ...
      <motion.div
        ...
        style={{ background: 'var(--brand-dark-gray)', borderTop: '1px solid rgba(231, 129, 253, 0.1)' }}
      >
