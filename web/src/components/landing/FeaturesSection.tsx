      ...
      <div className='container' style={{ maxWidth: '1400px', padding: '0 30px', margin: '0 auto' }}>
        ...
        <div className='hybrid-section mt-24'>
          ...
          <div className='movement relative'>
            ...
            <div className='line-image-container absolute inset-0 z-2 line-image01'>
              <img src='/images/nexus/section3/line01.svg' alt='line' className='absolute' style={{ width: '41.7%', top: '26.3%', left: '2.3%' }} />
