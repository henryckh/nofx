      ...
      <div className="flex border-b" style={{ borderColor: '#2B3139' }}>
        <button
          ...
          style={{
            ...
            borderBottomColor: activeTab === 'trades' ? '#F0B90B' : 'transparent',
          }}
        >
          COMPLETED TRADES
        </button>
        <button
          ...
          style={{
            ...
            borderBottomColor: activeTab === 'model-chat' ? '#F0B90B' : 'transparent',
          }}
        >
          MODELCHAT
        </button>
        <button
          ...
          style={{
            ...
            borderBottomColor: activeTab === 'positions' ? '#F0B90B' : 'transparent',
          }}
        >
          POSITIONS
        </button>
